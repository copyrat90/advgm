...
DMG_AUDIO:= $(call glob,$(DMG_AUDIO_FILES))
...
GEN_S	:= $(foreach bin,$(BINARY),$(call gen_s,$(bin),.S)) \
	   ...
	   $(foreach dmg_aud,$(DMG_AUDIO),$(call gen_s,$(dmg_aud),.c))
...
$(call gen_s,$(1),.c) &: $(1)
	@echo "advgm_conv  $$<"
	$$(SILENT)$$(PYTHON) -B $$(ADVGM_CONV) --input=$(1) --output=$(call gen_s,$(1),.c) --c-array=$(basename $(notdir $(1))) > /dev/null
endef
...
# Process DMG audio files
$(foreach dmg_audio,$(DMG_AUDIO),$(eval $(call advgm_conv,$(dmg_audio))))
